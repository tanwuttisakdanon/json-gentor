...
import { Plus, Clock, ArrowRight, CodeXml } from 'lucide-react';
...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#FCFCFC] p-8 lg:p-12 font-sans selection:bg-[#A3B18A] selection:text-white">
            <div className="max-w-5xl mx-auto">

                {/* Hero Section สไตล์คลีนๆ */}
                <div className="bg-white rounded-3xl p-10 border border-zinc-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
                    <div className="max-w-lg">
                        ...
                        <p className="text-zinc-500 text-lg mb-8 leading-relaxed">
                            ออกแบบโครงสร้าง JSON ใส่ข้อมูลจำนวนมาก และส่งออกเพื่อนำไปทดสอบ API ของคุณในไม่กี่คลิก สไตล์มินิมอล รวดเร็ว และเป็นระเบียบ
                        </p>
                        <button
                    ...
                    <div className="hidden md:block">
                        <DataGraphic className="w-64 h-64 drop-shadow-sm animate-[bounce_6s_ease-in-out_infinite]" />
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="bg-white border border-dashed border-zinc-200 rounded-3xl p-16 text-center flex flex-col items-center justify-center">
                        ...
                        <p className="text-zinc-400 max-w-sm mx-auto">ดูเหมือนว่าคุณยังไม่ได้สร้างโปรเจกต์ใดๆ กดปุ่มเริ่มต้นโปรเจกต์ใหม่ด้านบนเพื่อลุยได้เลย</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {projects.map((project) => (
                            <div
                                ...
                                className="group bg-white border border-zinc-200 p-6 rounded-2xl hover:border-[#A3B18A] hover:shadow-lg hover:shadow-[#A3B18A]/10 transition-all cursor-pointer flex flex-col justify-between h-48"
                            >
                                <div>
